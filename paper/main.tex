...
\begin{itemize}
    ...
    \item \textbf{No policy simulation:} We document diagnostic fairness disparities but do not simulate their downstream consequences---e.g., how many students would be misallocated to interventions, the resource cost of false positives, or the opportunity cost of false negatives under realistic budget constraints. Translating fairness metrics into intervention allocation models would strengthen the practical relevance of these findings.
...
\begin{itemize}
    ...
    \item \textbf{Policy simulation:} Translating fairness metrics into concrete resource allocation models---estimating how many students would be misidentified, the per-pupil cost of false positives, and the opportunity cost of missed at-risk students under realistic budget constraints---would bridge the gap between diagnostic auditing and actionable policy guidance.
