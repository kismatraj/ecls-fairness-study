...
Thousands of school districts now use machine learning to flag students at risk of academic failure, and the practice is accelerating \citep{baker2014educational}. The premise is intuitive: identify struggling students early, intervene before they fall behind, close achievement gaps. Yet a critical assumption underlying these early warning systems (EWS) has gone largely untested---that the algorithms work equitably across the demographic groups they are meant to serve.
