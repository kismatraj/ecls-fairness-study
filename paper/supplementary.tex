...
\large When Algorithms Mirror Inequality: Structural Encoding of Fairness Disparities in Early Childhood Risk Prediction}

\author{
    Kismat Raj Vishwakarma\textsuperscript{1}, Kumkum Basu\textsuperscript{2}, and Abhinaba Basu\textsuperscript{1}\\[0.3cm]
    \small\textsuperscript{1}National Institute of Electronics \& Information Technology (NIELIT), India\\
    \small\textsuperscript{2}Uttar Pradesh Basic Education Department, India\\[0.2cm]
    \small Corresponding author: kismat.vishwakarma@gmail.com
}
