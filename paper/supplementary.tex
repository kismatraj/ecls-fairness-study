...
\caption*{\textbf{Figure S8.} Calibration Curves by Racial/Ethnic Group. Deviation from the diagonal indicates miscalibration. Black students show the largest deviation, consistent with the ECE ratio of 3.35 reported in the main text.}
...
X\_CHSEX\_R & 0.000 & 0.000 & 1.000 & 9.5 & 9.5 \\
X\_RACETH\_R & 0.000 & 0.000 & 1.000 & 9.5 & 9.5 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{table}[H]
\centering
\caption*{\textbf{Table S7.} Fairness Metrics by Racial/Ethnic Group for Reading and Math Outcomes (with 95\% Bootstrap Confidence Intervals). Both outcomes show higher TPR for Hispanic and Black students relative to White students. Math shows notably higher FPR for Black students (0.161) than reading (0.095).}
...
\midrule
\multirow{4}{*}{Reading}
 & Asian & 4.661 & +0.589 & 0.000 & $-$0.011 & No \\
